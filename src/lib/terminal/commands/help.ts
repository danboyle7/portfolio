  ...
  execute: (args): CommandResult => {
    ...
    return {
      output: [
        ...
        createLine('  env            List environment variables', 'output'),
        ...
        createLine('', 'output'),
        createLine('  SHELL FEATURES', 'success'),
        createLine('  --------------', 'system'),
        createLine('  VAR=value      Set a variable', 'output'),
        createLine('  export VAR=val Export a variable', 'output'),
        createLine('  unset VAR      Unset a variable', 'output'),
        createLine('  echo $VAR      Print a variable', 'output'),
        createLine('  echo $?        Last command exit code', 'output'),
        createLine('  echo $0        Shell name', 'output'),
        createLine('', 'output'),
