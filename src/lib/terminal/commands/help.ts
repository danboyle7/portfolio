...
export const helpCommand: Command = {
  ...
  execute: (args): CommandResult => {
    if (args.length > 0) {
      ...
      return {
        output: [
          createLine(`help: no help topics match '${cmdName}'`, "error"),
        ],
      };
    }
    ...
    return {
      output: [
        ...
        createLine("  ----------", "system"),
        createLine(
          "  cd <dir>       Change directory (try: cd ~/experience)",
          "output",
        ),
