...
export const rebootCommand: Command = {
  ...
  execute: (): CommandResult => {
    ...
    addLine("", 0);
    addLine(
      '<span class="term-yellow">Broadcast message from root@portfolio:</span>',
      100,
    );
    addLine("", 50);
    addLine(
      '<span class="term-dim">The system is going down for reboot NOW!</span>',
      150,
    );
    addLine("", 200);
    addLine(
      '<span class="term-dim">Stopping portfolio services...</span>',
      150,
    );
    addLine(
      '<span class="term-green">[  OK  ]</span> Stopped Portfolio Terminal',
      100,
    );
    addLine(
      '<span class="term-green">[  OK  ]</span> Stopped Session Manager',
      100,
    );
    ...
    addLine(
      '<span class="term-green">[  OK  ]</span> Reached target Shutdown',
      150,
    );
    addLine("", 200);
