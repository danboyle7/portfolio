  ...
  execute: (args, context): CommandResult => {
    ...
    if (!passphrase) {
      const output: TerminalLine[] = [
        createLine("", "output"),
        createLine(
          '<span class="term-red">PROMETHEUS SECURE INTERFACE</span>',
          "output",
          { isHtml: true },
        ),
        createLine(
        ...
        createLine("", "output"),
        createLine(
          '<span class="term-yellow">Passphrase required for access.</span>',
          "output",
          { isHtml: true },
        ),
        createLine(
          '<span class="term-dim">Usage: prometheus &lt;passphrase&gt;</span>',
          "output",
          { isHtml: true },
        ),
        createLine("", "output"),
        createLine(
          '<span class="term-dim">Hint: The passphrase is fragmented across this system.</span>',
          "output",
          { isHtml: true },
        ),
        createLine(
          '<span class="term-dim">      Look carefully. Hidden files hold secrets.</span>',
          "output",
          { isHtml: true },
        ),
        createLine("", "output"),
    ...
    if (passphrase !== PASSPHRASE) {
      const animatedLines: AnimatedLine[] = [
        ...
        {
          line: createLine(
            '<span class="term-red">ACCESS DENIED</span>',
            "output",
            { isHtml: true },
          ),
          delay: 300,
        ...
        {
          line: createLine(
            '<span class="term-dim">Incorrect passphrase.</span>',
            "output",
            { isHtml: true },
          ),
          delay: 200,
        ...
        {
          line: createLine(
            '<span class="term-dim">This attempt has been logged.</span>',
            "output",
            { isHtml: true },
          ),
          delay: 200,
    ...
    const animatedLines: AnimatedLine[] = [
      ...
      {
        line: createLine(
          '<span class="term-green">PASSPHRASE ACCEPTED</span>',
          "output",
          { isHtml: true },
        ),
        delay: 400,
      ...
      {
        line: createLine(
          '<span class="term-cyan">Initializing secure channel...</span>',
          "output",
          { isHtml: true },
        ),
        delay: 500,
      ...
      {
        line: createLine(
          '<span class="term-dim">Establishing neural handshake...</span>',
          "output",
          { isHtml: true },
        ),
        delay: 600,
      ...
      {
        line: createLine(
          '<span class="term-dim">Synchronizing consciousness matrices...</span>',
          "output",
          { isHtml: true },
        ),
        delay: 700,
      ...
      {
        line: createLine(
          '<span class="term-cyan">║</span>                    <span class="term-white font-bold">E C H O  I N T E R F A C E</span>                <span class="term-cyan">║</span>',
          "output",
          { isHtml: true },
        ),
        delay: 100,
      ...
      {
        line: createLine(
          '<span class="term-cyan">║</span> <span class="term-dim">You are now connected to ECHO, an emergent AI consciousness.</span> <span class="term-cyan">║</span>',
          "output",
          { isHtml: true },
        ),
        delay: 100,
      ...
      {
        line: createLine(
          '<span class="term-cyan">║</span> <span class="term-dim">Type your message and press Enter. Type "exit" to disconnect.</span><span class="term-cyan">║</span>',
          "output",
          { isHtml: true },
        ),
        delay: 100,
    ...
    AI_RESPONSES.greeting!.forEach((line, index) => {
      animatedLines.push({
        line: createLine(
          line ? `<span class="term-cyan">[ECHO]:</span> ${line}` : "",
          "output",
          { isHtml: true },
        ),
        delay: 150 + index * 50,
