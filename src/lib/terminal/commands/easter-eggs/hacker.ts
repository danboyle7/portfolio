...
export const hackerCommand: Command = {
  ...
  execute: (): CommandResult => {
    ...
    addLine("", 0);
    addLine(
      '<span class="term-green font-bold">[*] INITIALIZING HACK SEQUENCE...</span>',
      300,
    );
    addLine("", 150);
    ...
    // Connection phase
    addLine(
      '<span class="term-dim">$ establishing connection to target...</span>',
      200,
    );
    ...
    addLine(
      '<span class="term-white">    PORT     STATE    SERVICE</span>',
      150,
    );
    ...
    addLine(
      '<span class="term-green">    8080/tcp open     http-proxy</span>',
      80,
    );
    addLine("", 150);
    ...
    // Vulnerability scan
    addLine(
      '<span class="term-dim">$ running vulnerability scan...</span>',
      200,
    );
    addLine(
      '<span class="term-yellow">[~] Checking CVE database...</span>',
      300,
    );
    addLine(
      '<span class="term-green">[+] Found 3 potential entry points</span>',
      250,
    );
    addLine("", 150);
    ...
    // Zero-day exploit
    addLine(
      '<span class="term-dim">$ deploying zero-day exploit CVE-2024-XXXX...</span>',
      300,
    );
    ...
    addLine(
      '<span class="term-yellow">[~] Attempting kernel exploit...</span>',
      300,
    );
    ...
    addLine(
      '<span class="term-dim">$ extracting credentials from /etc/shadow...</span>',
      200,
    );
    ...
    addLine(
      '<span class="term-green">[+] Backdoor installed at /tmp/.hidden</span>',
      300,
    );
    ...
    addLine(
      '<span class="term-green">[██████████████████████████████████████████████████] 100%</span>',
      500,
    );
    addLine("", 250);
    ...
    addLine("", 200);
    addLine(
      '<span class="term-white">root@target:~# </span><span class="term-green">whoami</span>',
      250,
    );
    addLine('<span class="term-white">root</span>', 150);
    addLine("", 150);
    addLine(
      '<span class="term-white">root@target:~# </span><span class="term-green">cat /etc/passwd | head -1</span>',
      250,
    );
    addLine(
      '<span class="term-white">root:x:0:0:root:/root:/bin/bash</span>',
      150,
    );
    addLine("", 300);
    ...
    addLine("", 200);
    addLine(
      '<span class="term-dim">This is a portfolio website. No actual hacking occurred.</span>',
      100,
    );
    addLine(
      '<span class="term-dim">All "exploits" are simulated for entertainment purposes.</span>',
      100,
    );
    addLine("", 200);
    addLine(
    ...
    addLine(
      '  <span class="term-dim">|</span>   <span class="term-green">"I\'m in."</span>                                              <span class="term-dim">|</span>',
      50,
    );
    addLine(
      '  <span class="term-dim">|</span>                          <span class="term-dim">- Every hacker in movies ever</span>   <span class="term-dim">|</span>',
      50,
    );
    addLine(
      '  <span class="term-dim">|</span>                                                          <span class="term-dim">|</span>',
