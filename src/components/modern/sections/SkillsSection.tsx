      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-zinc-100 mt-2">
            Technical
            <span className="text-emerald-400"> expertise</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="flex lg:flex-col gap-2 overflow-x-auto pb-4 lg:pb-0 scrollbar-hide">
              {skills.map((category, index) => (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg text-left whitespace-nowrap transition-all duration-300 cursor-pointer ${
          ...
          >
            <div className="bg-zinc-800/30 rounded-2xl border border-zinc-700/50 p-6 sm:p-8">
