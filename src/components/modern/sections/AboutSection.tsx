      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-zinc-100 mt-2">
            ...
            <span className="text-emerald-400"> exceptional software</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-3 space-y-6">
            {about.bio.map((paragraph, index) => (
              <p
                key={index}
                className={`text-zinc-400 text-lg leading-relaxed transition-all duration-700 ${
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                }`}
            ...
            >
              <h3 className="text-zinc-200 font-semibold mb-4">What I bring to the table:</h3>
          ...
          >
            <div className="bg-zinc-800/50 rounded-2xl p-8 border border-zinc-700/50">
              <h3 className="text-zinc-200 font-semibold mb-6">Quick Facts</h3>
              ...
              {/* Location & Status */}
              <div className="mt-8 pt-6 border-t border-zinc-700/50 space-y-3">
